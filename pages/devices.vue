<template>
  <div>
    ...
    <div class="row">
      <card>
        <div slot="header">
          <h4 class="card-title">Agregar un Dispositivo</h4>
        </div>
        ...
        <div class="row">
          <div class="col-4">
            <base-input
              label="Device Name"
              type="text"
              placeholder="Ejemplo: Casa, Oficina..."
        ...
        <div class="row pull-right">
          <div class="col-12">
            <base-button
              ...
              class="mb-3"
              size="lg"
              >Agregar Dispositivo</base-button
            >
          </div>
        </div>
      </card>
      ...
      this.$axios
        ...
        .then(res => {
          ...
          if (res.data.status == "success") {
            ...
            this.$notify({
              ...
              message: " Status Saver Actualizado!"
            });
        ...
        .catch(e => {
          ...
          this.$notify({
            ...
            message: " Error al actualizar el Status Saver!"
          });
          return;
        });
    },
    ...
    createNewDevice() {
      if (this.newDevice.name == "") {
        this.$notify({
          type: "warning",
          icon: "tim-icons icon-alert-circle-exc",
          message: " Nombre del dispositivo vacío! :("
        });
        return;
      }
      ...
      if (this.selectedIndexTemplate == null) {
        this.$notify({
          type: "warning",
          icon: "tim-icons icon-alert-circle-exc",
          message: " Plantilla sin seleccionar"
        });
        return;
      }
        ...
        .then(res => {
          if (res.data.status == "success") {
            ...
            this.$notify({
              type: "success",
              icon: "tim-icons icon-check-2",
              message: "Bien! Dispositivo Añadido."
            });
        ...
        .catch(e => {
          if (
            ...
            this.$notify({
              ...
              icon: "tim-icons icon-alert-circle-exc",
              message:
                "El Dispositivo ya esta registrado. Intente otro."
            });
            return;
          } else {
